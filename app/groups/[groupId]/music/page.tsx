						...
						<div className="md:col-span-4 flex flex-col gap-10 overflow-hidden">
							<div className="bg-black/5 p-10 rounded-[3rem] flex flex-col gap-8 shrink-0">
								<div className="flex flex-col gap-2">
									<h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-deepInk/40">01. Source Control</h3>
									<h4 className="text-3xl font-black uppercase tracking-tighter text-deepInk">Add Track</h4>
								</div>
							...
							<div className="flex-1 flex flex-col gap-6 overflow-hidden">
								<div className="px-4">
									<h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-deepInk/40 mb-2">02. Queue List</h3>
									<h4 className="text-2xl font-black uppercase tracking-tighter text-deepInk">Current Rotation</h4>
								</div>
									...
									{state.tracks.map((t, i) => (
										...
										>
											<div className="flex items-center gap-6">
												...
												<span className="text-[10px] font-black uppercase tracking-widest truncate max-w-[200px]">{t.split('/').pop()}</span>
											</div>
											{i === state.currentIndex && <div className="w-1.5 h-1.5 rounded-full bg-neonLime animate-pulse"></div>}
										</div>
									))}
									{state.tracks.length === 0 && (
										<p className="text-[10px] font-black uppercase tracking-widest text-deepInk/20 px-2 italic">Queue is empty...</p>
									)}
								</div>
							</div>
						</div>
						...
						<div className="md:col-span-8 flex flex-col items-center justify-center relative bg-white pb-24">
							...
							<div className="mt-20 flex flex-col items-center gap-8">
								<div className="flex flex-col items-center gap-2">
									<span className="text-[10px] font-black uppercase tracking-[0.8em] text-deepInk/20">Now Streaming</span>
									<h3 className="text-4xl font-black uppercase tracking-tighter text-deepInk italic text-center max-w-[600px] leading-tight break-words px-8">
